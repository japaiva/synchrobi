...
CSRF_TRUSTED_ORIGINS = [
    ...
    "https://*.rssynchro.com.br",   # cobre subdomínios futuros
]
...
# Em DEBUG, usar storage simples; em produção, usar com compressão e manifesto
if DEBUG:
...
DATA_UPLOAD_MAX_NUMBER_FIELDS = 10000  # Aumentar para planilhas grandes
